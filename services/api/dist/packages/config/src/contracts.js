 ...
 */
export function getDeployedAddress(chainId, contractName) {
    ...
    if (!addr) {
        throw new Error(`@piggy/config/contracts: "${contractName}" not deployed on chain ${chainId}. ` +
 ...
 */
export function tryGetDeployedAddress(chainId, contractName) {
    try {
