 ...
 */
export declare function setSoftPausedById(goalId: string, softPaused: boolean): Promise<void>;
export declare function updateGoalAfterCycle(id: string, progressPct: number, didRebalance: boolean, blendedApy?: number): Promise<void>;
 ...
 */
export declare function markPaymentUsed(txHash: string, payerAddress: string, amountUsdc: number): Promise<boolean>;
