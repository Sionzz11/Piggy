 ...
 */
const CELO_TOKEN_ADDRESS = process.env.CELO_TOKEN_ADDRESS ?? (CHAIN_ID === 42220
 ...
 */
export async function fetchCeloPriceFromMento() {
    try {
...
// ── Main export ────────────────────────────────────────────────────────────
export async function evaluateGasPolicy() {
