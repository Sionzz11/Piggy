...
export function enforceChainGuards() {
    ...
    if (IS_MAINNET && !enabled) {
        throw new Error("[guards] Mainnet execution is BLOCKED.\n" +
    ...
    if (IS_MAINNET && process.env.NODE_ENV === "development") {
        throw new Error("[guards] Mainnet transactions blocked when NODE_ENV=development.\n" +
